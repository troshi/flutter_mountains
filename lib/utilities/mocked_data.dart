...
final List<MountModel> mountItems = [
  ...
  MountModel(
      path:
          'https://cdn.thinglink.me/api/image/7DceLftyMsyaeCNtdQd6gToRFE31FkDCUt1bZZH1ghKVMMuA5vt2N9ujGwby1tPnkWTWcgVchMBEbvGY1DZBc',
      name: 'Mauna Loa',
      description:
  ...
  MountModel(
      path:
          'https://volcanianoficial.com/wp-content/uploads/2016/01/Vesubio-1.png',
      name: 'Mount Vesuvius',
      description:
